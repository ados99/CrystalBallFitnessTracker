...
class InputsTest < ApplicationSystemTestCase
  ...
  test "creating a Input" do
    ...
    fill_in "Age", with: @input.age
    fill_in "Float", with: @input.float
    fill_in "Gender", with: @input.gender
    fill_in "Height", with: @input.height
    fill_in "Weight", with: @input.weight
