...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post inputs_url, params: { input: { age: @input.age, float: @input.float, gender: @input.gender, height: @input.height, weight: @input.weight } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { age: @input.age, float: @input.float, gender: @input.gender, height: @input.height, weight: @input.weight } }
